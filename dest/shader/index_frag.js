...
var _index_fragshader=[
	...
	"		if(!gold) gl_FragColor = c*alpha*5.0;",
	"		else gl_FragColor = vec4(c.r,c.g,c.b,c.a*alpha);",
	"		return;",
	"	}",
	"	float seed=0.05;",
	"	float distortion_x=0.3;",
	...
	"",		
	"",
	"	vec4 c=vec4(cga.r+cr.a, cga.g+cb.a, cga.b+cb.a,min(cga.a+cr.a+cb.a,1.0));",
	"		if(!gold) gl_FragColor = c*alpha*5.0;",
	"		else gl_FragColor = vec4(c.r,c.g,c.b,c.a*alpha);",
	"",		
	"",		
